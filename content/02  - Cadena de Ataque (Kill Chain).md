...
La explotación se ejecutó automáticamente mediante la cadena de exploits descrita en la sección de [[03 - Análisis Técnico del Malware]], sin requerir interacción del usuario.
